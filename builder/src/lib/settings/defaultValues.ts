...
export const createDefaultTemplateSettingsValues = (
    defaultValues: typeof defaultTemplateSettingValues,
    existingData?: typeof defaultTemplateSettingValues
) => {
...
export const createDefaultOpenGraphValues = (
    defaultValues: OpenGraphDefaultValues,
    siteUrl: string,
    siteName: string,
    existingData?: OpenGraphDefaultValues
) => {
    const values = defaultValues
